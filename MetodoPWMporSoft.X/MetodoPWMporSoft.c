...
#define PINPWM     PORTBbits.RB0 // indicar el pin de salida del PWM
#define TRISPWM    TRISBbits.RB0 // indicar el pin de salida del PWM
...
PWMout(150,800); //invocacion de la configuracion y el lanzador del metodo
TRISD=0;
